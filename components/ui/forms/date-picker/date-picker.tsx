...
export type DateTimePickerProps = {
    ...
    /**
     * If the date picker should close upon intial selection of a date.
     */
    exitOnClick?: boolean;
    /**
            ...
            <PopoverContent className="w-auto p-2">
                <div className="flex items-center justify-between">
                    <div className="text-md font-bold ms-2 flex items-center cursor-pointer">
                        <div>
                            <span
                                className="cursor-pointer hover:opacity-80 mr-1"
                                onClick={() =>
                                    setMonthYearPicker(
                            ...
                            <span
                                className="ms-1 cursor-pointer hover:opacity-80"
                                onClick={() =>
                                    setMonthYearPicker(
                ...
                <div className="relative overflow-hidden border-t pt-2">
                    <DayPicker
                        timeZone={timezone}
                        mode="single"
                        selected={date}
                    ...
                    <MonthYearPicker
                        ...
                        maxDate={maxDate}
                        className={cn(
                            "absolute top-0 left-0 bottom-0 right-0 pt-2",
                            monthYearPicker ? "" : "hidden"
                        )}
                    />
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    {!exitOnClick && (
                        <div className="flex flex-row-reverse items-center justify-between border-t mt-2 py-1">
                            <Button
                                className="ms-2 mt-2 h-7 px-2"
                                onClick={onSubmit}
                            >
                                Done
                            </Button>
