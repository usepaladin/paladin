...
const NavbarTabs: FC<Props> = ({ tabs }) => {
    ...
    return (
        <div className={`flex justify-center items-center w-full min-h-screen`}>
            <Card
                className={`w-full max-w-[1200px] h-[100px] border-none shadow-none relative flex items-center justify-center dark:bg-transparent
                }`}
            >
